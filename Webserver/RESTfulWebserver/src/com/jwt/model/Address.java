...
public class Address {
	...
	public Address(String country, String state, String city, int postcode, String housenumber, Double longitude,
			Double latitude) {
	...
	public Address(String country, String state, String city, int postcode, String street, String housenumber, Double longitude,
			Double latitude) {
		this.country = country;
		this.state = state;
		this.city = city;
	...
	public static JSONObject serializeAddress(Address address) {
		...
		addressJSON.put("postcode", address.postcode);
		addressJSON.put("housenumber", address.housenumber);
		addressJSON.put("longitude", address.longitude);
		addressJSON.put("latitude", address.latitude);
